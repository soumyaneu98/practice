...
public class SalesPersonDirectory {
    ...
    private ArrayList<SalesPersonProfile> salespersons;

    // Constructor and other methods...

    public SalesPersonProfile findSalesPersonByCustomer(CustomerProfile customer) {
        for (SalesPersonProfile salesperson : salespersons) {
            if (salesperson.hasCustomer(customer)) {
                return salesperson;
            }
        }
        return null; // Return null if no associated salesperson is found
    }
