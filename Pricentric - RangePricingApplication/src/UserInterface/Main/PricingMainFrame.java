...
import UserInterface.Main.WorkSpaceProfiles.CustomerWorkAreaJPanel;
...
public class PricingMainFrame extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        ...
        CustomerWorkAreaJPanel custworkarea;
        ...
        if (profile instanceof CustomerProfile) {
            ...
            CustomerProfile cp = (CustomerProfile) profile;
            custworkarea = new CustomerWorkAreaJPanel(business, CardSequencePanel, cp);
            CardSequencePanel.removeAll();
            CardSequencePanel.add("Customer", custworkarea);
            ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
